...
<body>
	...
	<section class="container">
		...
		<div class="row">
			<c:forEach items="${productss}" var="productt">
				<div class="col-sm-6 col-md-3" style="padding-bottom: 15px">
					<div class="thumbnail">
						<div class="caption">
							<h3>${productt.name}</h3>
							<p>${productt.description}</p>
							<p>${productt.unitPrice}USD</p>
							<p>Available ${productt.unitsInStock} units in stock</p>
							<p>
								<a
									href=" <c:url value="/products/product?id=${productt.productId}" /> "
